...
namespace MyGame.CraftingSystem
{
    public class CraftingUI : MonoBehaviour
    {
        ...
        [SerializeField] private TextMeshProUGUI selectRecipeInfo;
        ...
        private void RefreshRecipeList()
        {
            ...
            {
                CreateRecieButton(recipe);
            }
        }
        private void CreateRecieButton(Recipe recipe)
        {
        ...
        private void UpdateRecipeInfo()
        {
            ...
            {
                selectRecipeInfo.text = "Select a recipe";
        ...
        private void OnCraftButtonClick()
        {
            if (selectedRecipe != null)
            {
                ...
                {
                    Debug.Log($"조합성공 {selectedRecipe.resultItem.Name}");
